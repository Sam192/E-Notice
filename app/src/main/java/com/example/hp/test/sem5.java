...
public class sem5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_sem5, container, false);
        View view= inflater.inflate(R.layout.fragment_sem4, container, false);
        ...
        DatabaseReference databaseReference=FirebaseDatabase.getInstance().getReference("sem5");
        ...
        sem5_itemAdapter notesItemAdapter=new sem5_itemAdapter(recyclerView,getContext(),new ArrayList<String>(),new ArrayList<String>());
        //28 minutes
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                ((sem5_itemAdapter)recyclerView.getAdapter()).update(name,url);
            }
