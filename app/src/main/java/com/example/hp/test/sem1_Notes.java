 ...
 */
public class sem1_Notes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment    View view= inflater.inflate(R.layout.fragment_blank, container, false);
        //
        View view= inflater.inflate(R.layout.fragment_sem1__notes, container, false);
       ...
       // database=FirebaseDatabase.getInstance();//returns an object of firebasedatabase
        ...
        NotesItemAdapter notesItemAdapter=new NotesItemAdapter(recyclerView,getContext(),new ArrayList<String>(),new ArrayList<String>());
        //28 minutes
