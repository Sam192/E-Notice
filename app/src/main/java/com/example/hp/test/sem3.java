...
public class sem3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_sem3, container, false);
        View view= inflater.inflate(R.layout.fragment_sem3, container, false);
        ...
        DatabaseReference databaseReference=FirebaseDatabase.getInstance().getReference("sem3");
        ...
        sem3_itemAdapter notesItemAdapter=new sem3_itemAdapter(recyclerView,getContext(),new ArrayList<String>(),new ArrayList<String>());
        //28 minutes
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                ((sem3_itemAdapter)recyclerView.getAdapter()).update(name,url);
            }
