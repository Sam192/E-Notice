...
public class sem2_itemAdapter extends RecyclerView.Adapter<sem2_itemAdapter.ViewHolder> {
    RecyclerView recyclerView;
    Context context;
    ArrayList<String> items=new ArrayList<>();
    ArrayList<String> urls=new ArrayList<>();
    private DatabaseReference mReference = FirebaseDatabase.getInstance().getReference("sem2");
    private StorageReference storage = FirebaseStorage.getInstance().getReference("sem2");
    ...
    public sem2_itemAdapter(RecyclerView recyclerView, Context context, ArrayList<String> items,ArrayList<String> urls) {
    ...
    @Override
    public sem2_itemAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {   //to create views for recyclerview item
        ...
        View view= LayoutInflater.from(context).inflate(R.layout.sem2_item,parent,false);
        sem2_itemAdapter.ViewHolder viewHolder= new sem2_itemAdapter.ViewHolder(view);//returns object of viewholder class
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(sem2_itemAdapter.ViewHolder holder, int position) {
