...
public class NotesItemAdapter extends RecyclerView.Adapter<NotesItemAdapter.ViewHolder> {
    ...
    private DatabaseReference mReference = FirebaseDatabase.getInstance().getReference("sem1");
    private StorageReference  storage = FirebaseStorage.getInstance().getReference("sem1");
    ...
    public NotesItemAdapter(RecyclerView recyclerView, Context context, ArrayList<String> items,ArrayList<String> urls) {
    ...
    {   //to create views for recyclerview item
        ...
        View view= LayoutInflater.from(context).inflate(R.layout.itemrecycler,parent,false);
        ViewHolder viewHolder= new ViewHolder(view);//returns object of viewholder class
        return viewHolder;
    }
