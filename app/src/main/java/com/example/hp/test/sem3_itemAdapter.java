...
public class sem3_itemAdapter extends RecyclerView.Adapter<sem3_itemAdapter.ViewHolder> {
        RecyclerView recyclerView;
        Context context;
        ArrayList<String> items=new ArrayList<>();
        ArrayList<String> urls=new ArrayList<>();
    private DatabaseReference mReference = FirebaseDatabase.getInstance().getReference("sem3");
    private StorageReference storage = FirebaseStorage.getInstance().getReference("sem3");
...
public sem3_itemAdapter(RecyclerView recyclerView, Context context, ArrayList<String> items,ArrayList<String> urls) {
...
@Override
public sem3_itemAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
        ...
        sem3_itemAdapter.ViewHolder viewHolder= new sem3_itemAdapter.ViewHolder(view);//returns object of viewholder class
        return viewHolder;
        }

@Override
public void onBindViewHolder(sem3_itemAdapter.ViewHolder holder, int position) {
