...
public class sem6_itemAdapter extends RecyclerView.Adapter<sem6_itemAdapter.ViewHolder> {
        RecyclerView recyclerView;
        Context context;
        ArrayList<String> items=new ArrayList<>();
        ArrayList<String> urls=new ArrayList<>();
    private DatabaseReference mReference = FirebaseDatabase.getInstance().getReference("sem6");
    private StorageReference storage = FirebaseStorage.getInstance().getReference("sem6");
...
public sem6_itemAdapter(RecyclerView recyclerView, Context context, ArrayList<String> items, ArrayList<String> urls) {
...
@Override
public sem6_itemAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
        ...
        sem6_itemAdapter.ViewHolder viewHolder= new sem6_itemAdapter.ViewHolder(view);//returns object of viewholder class
        return viewHolder;
        }

@Override
public void onBindViewHolder(sem6_itemAdapter.ViewHolder holder, int position) {
