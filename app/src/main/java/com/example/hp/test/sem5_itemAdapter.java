...
public class sem5_itemAdapter extends RecyclerView.Adapter<sem5_itemAdapter.ViewHolder> {
        RecyclerView recyclerView;
        Context context;
        ArrayList<String> items=new ArrayList<>();
        ArrayList<String> urls=new ArrayList<>();
    private DatabaseReference mReference = FirebaseDatabase.getInstance().getReference("sem5");
    private StorageReference storage = FirebaseStorage.getInstance().getReference("sem5");
...
public sem5_itemAdapter(RecyclerView recyclerView, Context context, ArrayList<String> items, ArrayList<String> urls) {
...
@Override
public sem5_itemAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
        ...
        sem5_itemAdapter.ViewHolder viewHolder= new sem5_itemAdapter.ViewHolder(view);//returns object of viewholder class
        return viewHolder;
        }

@Override
public void onBindViewHolder(sem5_itemAdapter.ViewHolder holder, int position) {
