...
public class sem6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_sem6, container, false);
        ...
        DatabaseReference databaseReference=FirebaseDatabase.getInstance().getReference("sem6");
        ...
        sem6_itemAdapter notesItemAdapter=new sem6_itemAdapter(recyclerView,getContext(),new ArrayList<String>(),new ArrayList<String>());
        //28 minutes
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                ((sem6_itemAdapter)recyclerView.getAdapter()).update(name,url);
            }
